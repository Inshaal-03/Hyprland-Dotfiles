...
# WALLPAPERS PATH
terminal=kitty
wallDIR="$HOME/Wallpaper-Partition"
SCRIPTSDIR="$HOME/dotfiles/hypr/scripts"
wallpaper_current="$HOME/dotfiles/hypr/hypr/wallpaper_effects/.wallpaper_current"
...
# Variables
rofi_theme="~/dotfiles/rofi/config-wallpaper.rasi"
...
main() {
  ...
  if [[ "$selected_file" =~ \.(mp4|mkv|mov|webm|MP4|MKV|MOV|WEBM)$ ]]; then
    ...
    notify-send "Colorscheme Changed" "Colorscheme has changed according to $choice_basename wallpaper"
  fi
}
