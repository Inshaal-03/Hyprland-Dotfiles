...
-- Diagnostic keymaps
vim.keymap.set("n", "<S-l>", vim.diagnostic.open_float, { desc = "Open diagnostic [Q]uickfix list" })
...
require("lazy").setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-x>", builtin.diagnostics, { desc = "[S]earch [D]iagnostics" })
      vim.keymap.set("n", "<leader>sr", builtin.resume, { desc = "[S]earch [R]esume" })
      vim.keymap.set("n", "<leader>s.", builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
      vim.keymap.set("n", "<C-b>", builtin.buffers, { desc = "[ ] Find existing buffers" })
      vim.keymap.set("n", "<C-g>", builtin.current_buffer_fuzzy_find, { desc = "[/] Fuzzily search in current buffer" })
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        html = { filetypes = { "javascriptreact" } },
        lua_ls = {
          -- cmd = { ... },
          -- filetypes = { ... },
          -- capabilities = {},
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        javascript = { "eslint-lsp", "prettierd", "prettier", stop_after_first = false },
        javascriptreact = { "eslint-lsp", "prettierd", "prettier" },
      },
    },
  },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Simple and easy vim.g.ministatusline_disable`statusline.
  ...
  --     opts = {
  --         keyboard_mode = true,
  --         vim.keymap.set("n", "<M-k>", ":EagleWin<CR>", { noremap = true, silent = true }),
